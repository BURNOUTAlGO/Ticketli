      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-1.5">
            ...
            <h1 className="text-2xl font-bold text-[var(--color-text)] font-mono">
              My Requests
            </h1>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3 mb-3">
                      ...
                      {/* Status badge */}
                      <span
                        className={`flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-lg border flex-shrink-0 ${bg} ${text}`}
                      >
                        <Icon size={13} />
                        {label}
                      </span>
                    ...
                    {isRejected && (
                      <p className="mt-2 text-xs text-[var(--color-text-subtle)]">
                        The seller declined this request. This notice will
