      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--color-bg)]">
          <div className="text-center">
            <Train
              size={40}
              className="mx-auto mb-4 text-[var(--color-text-subtle)] opacity-40"
            />
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-1.5 text-sm text-[var(--color-text-subtle)] mb-6 flex-wrap font-mono">
            <Link to="/" className="hover:text-[var(--rail-orange)] transition">
              Home
            </Link>
            <ChevronRight size={14} />
            <Link
              to="/browse"
              className="hover:text-[var(--rail-orange)] transition"
            >
              Browse Tickets
            </Link>
            <ChevronRight size={14} />
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0 flex flex-col gap-5">
                ...
                <div className="flex items-start gap-3 bg-yellow-50 border-2 border-yellow-300 rounded-2xl px-4 py-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-yellow-600 mt-0.5 leading-relaxed">
                      The seller has marked this listing as sold. It is no
              ...
              >
                ...
                {/* Time box */}
                <div
                  className={`border rounded-xl p-4 md:p-5 mb-5 ${
                    isSold
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex-1 flex flex-col items-center gap-1 px-2">
                      {duration && (
                        <span className="text-xs text-[var(--color-text-subtle)] font-medium font-mono">
                          {duration}
                        </span>
                      )}
                      <div className="flex items-center w-full gap-1">
                        <div
                          className={`flex-1 h-px ${isSold ? "bg-yellow-300" : "bg-[var(--color-border)]"}`}
                        />
                        <Train
                          size={16}
                          className={
            ...
            <div className="w-full lg:w-72 flex-shrink-0">
              <div
                ...
                style={{ top: "calc(var(--navbar-height, 64px) + 1.5rem)" }}
              >
                <div
                ...
                >
                  ...
                  <p
                    className={`text-3xl font-bold mb-1 font-mono ${isSold ? "text-yellow-800" : "text-[var(--color-text)]"}`}
                  >
                    ₹{ticket.price}
                  </p>
                  <p className="text-xs text-[var(--color-text-subtle)] mb-5">
                    Total for {ticket.seats}: ₹
                    {Number(ticket.price) * parseInt(ticket.seats)}
                  </p>

                  <div
                    className={`border-t mb-4 ${isSold ? "border-yellow-200" : "border-[var(--color-border)]"}`}
                  />
                  ...
                  {isSold ? (
                    <div className="flex flex-col gap-3">
                      ...
                      <p className="text-[11px] text-[var(--color-text-subtle)] text-center leading-relaxed">
                        This ticket is no longer available. Browse other
                        listings to find a similar route.
                      </p>
                      <button
                        onClick={() => navigate("/browse")}
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <p className="text-[11px] text-[var(--color-text-subtle)] text-center leading-relaxed">
                        The seller will review your request. You'll be able to
                        see their contact details once approved.
                      </p>
                      <Link
                        to="/my-requests"
                        className="rail-focus w-full flex items-center justify-center gap-1.5 border border-[var(--color-border)] text-[var(--color-text)] text-xs font-medium py-2.5 rounded-xl hover:bg-[var(--color-surface-hover)] transition"
                  ...
                  {!isAuthenticated && !isSold && (
                    <p className="text-[11px] text-[var(--color-text-subtle)] text-center mt-3 leading-relaxed">
                      You'll be redirected to login before contacting the
                      seller.
                    </p>
                  )}
                </div>
